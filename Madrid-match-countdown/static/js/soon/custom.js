(function($) {
    ...
    **/
    ...
    var hour = parseInt(document.getElementById('hour').value,10)-2;
    var launch = new Date(year, month, day, hour, 30, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    var minutes = $('#minutes');
    var seconds = $('#seconds');
    var opponent = document.getElementById('opp').value;
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('Match is currently going on!');
        }
        else{
            ...
            message.html('against '+opponent+' at '+ location);
        }
    }
})(jQuery);
/******************************************************************************************************************************
